...
<head>
    ...
    <style>
        ...
        .admin-only { display: <?php echo isset($_SESSION['admin']) ? 'inline-block' : 'none'; ?>; }
    </style>
</head>
<body>
    ...
    <div class="container my-5">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">11. Vadecir</li>
        ...
        <section>
            <h2>Lista de Pagamentos - <?php echo date('F Y'); ?></h2>
            <table class="table table-striped">
                ...
                <tbody id="paymentTable">
                    ...
                    <tr><td>Vadecir</td><td>Sim</td><td class="player-pending">Pendente</td><td><button class="btn btn-sm btn-warning toggle-payment admin-only" data-player="Vadecir">Alterar</button></td></tr>
    ...
    <script>
        ...
        function getNextWednesday() {
            ...
            return nextWednesday.toLocaleDateString('pt-BR', { day: '2-digit', month: 'long', year: 'numeric' });
        }
        ...
        function loadGameInfo() {
            fetch('get_game_info.php')
                ...
                .then(data => {
                    document.getElementById('gameLocation').textContent = data.location;
                    document.getElementById('gameDate').textContent = data.game_date;
                    document.getElementById('gameTime').textContent = data.game_time;
                    document.getElementById('locationInput').value = data.location;
                    document.getElementById('dateInput').value = data.game_date;
                    document.getElementById('timeInput').value = data.game_time;
                })
                .catch(error => console.error('Erro ao carregar game info:', error));
        }
